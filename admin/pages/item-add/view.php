            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="mt-4">
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">ชื่อเรื่อง (ภาษาอื่น ๆ)</label>
                            <input type="email" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" placeholder="Enter email">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">หน้าปกแสดง</label>
                        ...
                        <div class="row author-main">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">ประเภทผู้เขียน</label>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="writer_main"
                                            id="writer_main1">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">ปีที่ออก</label>
                                    <input type="email" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" placeholder="Enter email">
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">บทคัดย่อ</label>
                            <textarea id="title"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">หน่วยงานสนับสนุน</label>
                            <input type="email" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" placeholder="Enter email">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">การอ้างอิง</label>
                            <input type="email" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" placeholder="Enter email">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">สำนักพิมพ์</label>
                            <input type="email" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" placeholder="Enter email">
                        </div>
                        <div class="row subject">
                            <div class="col-md-10">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" name="subject_name"
                                        aria-describedby="emailHelp" placeholder="Enter email">
                                </div>
                            </div>
                            <div class="col-md-2 pt-4">
